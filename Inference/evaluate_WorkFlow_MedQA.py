...
#     "model_gemma_27b": model_gemma_27b,
...
#     "model_Qwen25_32b": model_Qwen25_32b,
# }
...
with open("./diffMedQA.json", 'r', encoding='utf-8') as file:
    class_data = json.load(file)


async def main():
    with open("WorkFlow_MedQA.txt", "w") as f:
        ...
        for i, item in enumerate(data):
            ...
            Answer_Prompt = Answer_Prompt_1 + str(question) +str(options) + Answer_Prompt_example
            Question_Prompt = "Question:\n" + str(question)+str(options) + Answer_Prompt_example
